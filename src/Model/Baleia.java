...
public class Baleia extends Animal{
    ...
    public boolean isTemnadadeira() {
        return temnadadeira;
    }

    public void setTemnadadeira(boolean temnadadeira) {
        this.temnadadeira = temnadadeira;
    }

    Baleia(String nomedoanimal, String especie, String tipodealimentacao, int idade, float estimativadeVida, boolean temRabo, boolean temChifre, boolean temPelos, boolean temEscama, int quantPatas) {
